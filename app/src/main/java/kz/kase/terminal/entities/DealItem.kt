...
class DealItem(val id: Int, val symbol:String): RowItemInterface {
    ...
    fun rowItem(item: Column): RowItem {
        ...
        when (item) {
            ...
            Column.serial_order -> return RowItem(RowType.SimpleRow, symbol).update(RowValue(random.nextInt(99999999) ), R.color.colorGreyLight)
