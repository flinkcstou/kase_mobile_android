package kz.kase.fixtablelayout.widget;
...
public class TableLayoutManager extends RecyclerView.LayoutManager {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        //        Log.i("feng",
        //              " tag  ?  count " + getChildCount() + " change: " + state.didStructureChange() + " obj : " + this.string() + " PreLayout :" + state.isPreLayout() + " Measure : " + state.isMeasuring());
