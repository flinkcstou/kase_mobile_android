...
class NewArcDealDialog() : DialogFragment() {
    ...
    companion object {
        fun newInstance(): NewArcDealDialog {
            val fragment = NewArcDealDialog()
            val bundle = Bundle()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.instrument = InstrumentItem(0, "KZT")
        binding.blockInstrument.visibility = View.GONE
        binding.blockOrderType.visibility = View.GONE
        binding.labelExpire.text = getString(R.string.deal_date)
        binding.title.text = getString(R.string.archive_deal)
        binding.send.text = getString(R.string.save)
        isCancelable = true
